 ...
 * an element class. By this way, execution algorithm of element can vary as and when visitor varies.
 ...
 *
 * VisitorPatternDemo, our demo class, will use Computer and ComputerPartVisitor classes to demonstrate
